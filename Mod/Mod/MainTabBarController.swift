...
class MainTabBarController: UITabBarController {
  ...
  let movie = MovieCoordinator()
  let tabBarItemInfos: [UITabBarItemInfo] = [UITabBarItemInfo(title: "電影199", image: nil, selectedImage: nil)]
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
    viewControllers = [movie.navigationController]
  }
